...
public class ImmigrationTest extends Base{
	...
	@Test(priority = 1, description =  "TC8 = Add Immigration details with passport as the Document")
	...
	@Test(priority = 2, description =  "TC9 = Add Immigration details with visa as the Document")
	...
	@Test(priority = 3, description =  "TC10 = Add Immigration details without passport/visa number")
	...
	@Test(priority = 4, description =  "TC11 = Add Immigration details when expiry date less than issue date")
	...
	@Test(priority = 5, description =  "TC12 = While creating immigration details click on Add button")
	...
	@Test(priority = 6, description =  "TC13 = Creating multiple Immigration details for the same employee")
	...
	@Test(priority = 7, description =  "TC14 = Edit Existing Immigration Details")
	...
	@Test(priority = 8, description =  "TC15 = Delete Immigration record by using delete icon")
	...
	@Test(priority = 9, description =  "TC16 = Delete Immigration record by using delete checkbox near particular Immigration record")
	...
	@Test(priority = 10, description =  "TC17 = Attach documents under Immigration")
...
//		addImmigrationDetailsWithPassport();
	...
	@Test(priority = 11, description =  "TC18 = Replace existing Attach under Immigration")
...
//		addAttachmentUnderImmigration();
	...
	@Test(priority = 12, description =  "TC19 = Delete existing Attach under Immigration using Delete icon")
...
//		addAttachmentUnderImmigration();
	...
	@Test(priority = 13, description =  "TC20 = Delete existing Attach under Immigration by selecting checkbox near particular entry")
	...
	@Test(priority = 14, description =  "TC21 = Download existing Attach under Immigration")
