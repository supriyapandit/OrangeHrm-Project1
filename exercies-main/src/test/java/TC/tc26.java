...
public class tc26 extends basictc {
	 @Test(description = "tc 26: Verify Scroll Up without 'Arrow' button and Scroll Down functionality")
	    ...
	    public void verifyScrollUpWithoutArrowButtonAndScrollDownFunctionality() throws InterruptedException {
	        ...
	        tc25.verifySubscriptionIsVisible();
